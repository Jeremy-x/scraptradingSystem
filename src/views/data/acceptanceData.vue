      ...
      <div>
        <el-dialog title="出库单详情" :visible.sync="dialogTableVisible">
          <el-table :data="gridData" border>
            <el-table-column property="coreName" label="核心企业名称"></el-table-column>
            <el-table-column property="name" label="客户名称"></el-table-column>
            <el-table-column property="date" label="出库时间"></el-table-column>
            <el-table-column property="number" label="出库单号"></el-table-column>
            <el-table-column property="senderName" label="发货人"></el-table-column>
            <el-table-column property="senderTel" label="发货人联系方式"></el-table-column>
            <el-table-column property="acceptName" label="收货人"></el-table-column>
            <el-table-column property="acceptTel" label="收货人联系方式"></el-table-column>
          </el-table>
